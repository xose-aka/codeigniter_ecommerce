...
<div class="row">
    ...
    <div class="span9">
        <ul class="breadcrumb">
            ...
            <li><a href="<?= base_url('products') ?>">Items</a> <span class="divider">/</span></li>
        ...
        <div class="well well-small">
            <div class="row-fluid">
                        ...
                        <div class="carousel-inner">
                            <?php foreach ($images as $key => $image): ?>
                                <div class="item <?= $key === 0 ? 'active' : '' ?>">
                                    <a href="#"> <img src="<?= $image['path'] . $image['title'] ?>" alt="" style="width:100%"></a>
                                </div>
                            <?php endforeach; ?>
                        </div>
                ...
                <div class="span7">
                    <h3><?= $product['title'] ?> [$<?= $product['price_dollar'] ?>]</h3>
                    <hr class="soft"/>

                    <form class="form-horizontal qtyFrm" action="<?= base_url('put_cart') ?>" method="post">
                        <div class="control-group">
                            <label class="control-label"><span>$140.00</span></label>
                            <div class="controls">
                                <input type="number" class="span6" name="quantity" placeholder="Qty." value="2">
                            </div>
                        </div>
                        ...
                        <p>
                            <input type="hidden" name="price_euro" value="<?= $product['price_euro'] ?>">
                            <input type="hidden" name="price_dollar" value="<?= $product['price_dollar'] ?>">
